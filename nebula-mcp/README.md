...
- **Tools:** 134 across 15 categories (see [TOOLS.md](TOOLS.md)).
- **Also implements** MCP resources (`resources/*`), prompts (`prompts/*`),
  progress streaming, and runtime `logging/setLevel`.
